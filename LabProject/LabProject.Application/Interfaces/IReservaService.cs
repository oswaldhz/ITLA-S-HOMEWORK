...
public interface IReservaService
{
    ...
    Task<ReservaDto?> ActualizarAsync(int id, CreateReservaRequest request, ReservationValidationResult? validationResult = null, CancellationToken cancellationToken = default);
